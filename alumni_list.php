                ...
                <div class="card alumni-list" data-id="<?php echo $row['id'] ?>">
                    ...
                    <div class="card-body">
                        <div class="row align-items-center h-100">
                            <div class="">
                                <div>
                                <p class="filter-txt-1"><b><?php echo $row['name'] ?></b></p>
                                <hr class="divider w-100" style="max-width: calc(100%)">
                                <p class="filter-txt">Email: <br></p><?php echo $row['email'] ?></b>
                                <p class="filter-txt">Course:<br></p><?php echo $row['course'] ?></b>
                                <p class="filter-txt">Batch: <br></p><?php echo $row['batch'] ?></b>
                                <p class="filter-txt">Occupation <br></p><?php echo $row['connected_to'] ?></b>
                                    <br>
                                </div>
                            </div>
                        </div>
