						...
						<table class="table table-condensed table-bordered table-hover">
							...
							<?php 
								...
								while($row=$events->fetch_assoc()):
									if(new DateTime("now") < new DateTime($row['schedule'])){
								...
								<tr>
									...
									<td class="display-6 text-centered">
										 <p class="text-right"><?php echo $commits ?><br> <a href="index.php?page=event_participants&event_id=<?php echo $row['id'];?>">View</a>
